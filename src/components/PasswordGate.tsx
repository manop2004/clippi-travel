  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: C.bg }}>
      <form onSubmit={handleSubmit} className="w-full max-w-sm bg-white rounded-3xl p-6 border shadow-xl" style={{ borderColor: C.line }}>
        ...
        <h2 className="text-center text-sm font-black mb-1" style={{ color: C.ink }}>Demo Access</h2>
        <p className="text-center text-[11px] text-[#8A7870] mb-4">Enter the demo password to continue</p>
        <input
          type="password"
          value={input}
        ...
        />
        {error && <p className="text-[10px] text-[#E0533C] mb-2 font-semibold">Incorrect password, try again.</p>}
